...
\title{ight Years of FAIMS Mobile: Bringing FAIR data to HASS} % Presentation title
...
\begin{frame}{Using the wrong tools hinders research}
  \begin{figure}[H]
    \centering
        \includegraphics[height=.7\textheight]{figures/Ocean-Health-Index.jpg}
        \caption{Spreadsheets, though ubiquitous in research, are rarely a good idea...}
