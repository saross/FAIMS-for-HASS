...
Bringing FAIR data to HASS field research

Abstract

The 'open research' movement to is coming to Humanities, Arts, and Social Sciences research, requiring the publication of data, methods, and other processes in order to make research more transparent and verifiable. In future, researchers will be asked to publish FAIR-compliant datasets and other 'digital research objects' in public data repositories. 

To accomplish these goals, HASS disciplines need and deserve research-specific software designed with open research principles in mind, and with appropriate features and capabilities. We should not have to make do with mass-market software, and most projects cannot afford bespoke application development. 

FAIMS Mobile is an example of research-specific, generalised software. It allows teams of field research projects from archaeology, oral history, ethnography, linguistics, and similar disciplines to build custom application to collect structured, geospatial, multimedia, and free-text data offline, with later bi-directional synchronisation. Although it requires an initial investment in set-up and testing, analysis-ready datasets that are clean and consistent can be exported at the touch of a button, saving time at the end of project. At the same time, the cost of FAIMS Mobile customisation is a fraction of bespoke software development.

FAIMS Mobile has been under development since 2012, and a recent Australian Research Data Commons grant will allow us to rebuild the platform using modern components. This rebuild aims to lower barriers to entry and make project customisation and deployment much easier, thereby driving adoption.
